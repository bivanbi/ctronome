...
int parse_tact_count(char *line_buffer, struct ProgramFile *program_file, struct ProgramLine *program_line) {
    int tact_repeat_count = atoi(line_buffer);
...
int parse_beat_per_minute(char *line_buffer, struct ProgramFile *program_file, struct ProgramLine *program_line, struct CharacterPositions *space_positions) {
    program_line->beat_per_minute[0] = atoi(&line_buffer[space_positions->positions[0] + 1]);
...
int parse_bpm_base_note(char *line_buffer, struct ProgramFile *program_file, struct ProgramLine *program_line, struct CharacterPositions *space_positions) {
    ...
    if (slash_position < 0) {
        ...
        program_line->beat_per_minute[1] = atoi(&line_buffer[slash_position + 1]);
...
int parse_beat_per_tact(char *line_buffer, struct ProgramFile *program_file, struct ProgramLine *program_line, struct CharacterPositions *space_positions) {
    program_line->beat_per_tact[0] = atoi(&line_buffer[space_positions->positions[1] + 1]);
...
int parse_bpt_base_note(char *line_buffer, struct ProgramFile *program_file, struct ProgramLine *program_line, struct CharacterPositions *space_positions,
    ...
    if (slash_position < 0) {
        ...
        program_line->beat_per_tact[1] = atoi(&line_buffer[slash_position + 1]);
