...
int main(int argc, char *argv[]) {
    ...
    if (args.is_program) {
        play_program(&dsp_device, &wav1, &wav2, &args);
    } else {
        play_simple_tact(&dsp_device, &wav1, &wav2, &args);
    }
...
void play_program(struct DspDevice *dsp_device, struct WavData *wav1, struct WavData *wav2, struct Arguments *args) {
    ...
    while (args->repeat_count > 0) {
        ...
        output_tact(dsp_device, wav1, wav2, args);
    }
